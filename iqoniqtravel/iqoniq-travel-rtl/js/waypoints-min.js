...
function() {
	...
	! function(t, e) {
		...
		var o, i, l, u, s, a, c, f, d, h, p, v, y, g, w, m;
		return o = n(r), f = t.call(r, "ontouchstart") >= 0, u = {
			horizontal: {},
			vertical: {}
		}, s = 1, c = {}, a = "waypoints-context-id", p = "resize.waypoints", v = "scroll.waypoints", y = 1, g = "waypoints-waypoint-ids", w = "waypoint", m = "waypoints", i = function() {
			function t(t) {
				var e = this;
			...
			function t(t, e, r) {
				var o, i;
				"bottom-in-view" === (r = n.extend({}, n.fn[w].defaults, r)).offset && (r.offset = function() {
					var t;
					return t = n[m]("viewportHeight"), n.isWindow(e.element) || (t = e.$element.height()), t - n(this).outerHeight()
				}), this.$element = t, this.element = t[0], this.axis = r.horizontal ? "horizontal" : "vertical", this.callback = r.handler, this.context = e, this.enabled = r.enabled, this.id = "waypoints" + y++, this.offset = null, this.options = r, e.waypoints[this.axis][this.id] = this, u[this.axis][this.id] = this, (o = null != (i = t.data(g)) ? i : []).push(this.id), t.data(g, o)
			}
			...
			init: function(t, e) {
				return null == e && (e = {}), null == e.handler && (e.handler = t), this.each(function() {
					var t, r, o, u;
					return t = n(this), o = null != (u = e.context) ? u : n.fn[w].defaults.context, n.isWindow(o) || (o = t.closest(o)), o = n(o), (r = c[o.data(a)]) || (r = new i(o)), new l(t, r, e)
				}), n[m]("refresh"), this
			},
			disable: function() {
